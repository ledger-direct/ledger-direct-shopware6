...
class RlusdPaymentHandlerTest extends TestCase
{
    ...
    private const TOKEN = ['currency' => '524C555344000000000000000000000000000000', 'issuer' => 'rQhWct2fv4Vc4KRjRgMrxa8xPN9Zx9iLKV'];

    private OrderTransactionStateHandler $stateHandler;

    private OrderTransactionService $transactionService;

    private RlusdPaymentHandler $handler;
    ...
    {
        $otherToken = ['currency' => '5553444300000000000000000000000000000000', 'issuer' => 'rHuGNhqTG32mfmAvWA8hUyWRLV3tCSwKQt', 'value' => '1.16'];
