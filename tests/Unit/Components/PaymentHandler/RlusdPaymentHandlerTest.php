...
class RlusdPaymentHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new RlusdPaymentHandler($router, $this->stateHandler, $this->transactionService);
    ...
    public function testFinalizeMarksPartiallyPaidWhenAmountsDiffer(): void
    {
        $this->givenLedgerDirectCustomFields([
            'hash' => 'HASH', 'ctid' => 'CTID',
